 ...
 * 
 * Lit UNIQUEMENT depuis fiches_transport + fiches_transport_jours (système unifié).
 * L'ancien système fiches_transport_finisseurs n'est plus utilisé pour les nouvelles données.
 * 
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<TransportSheet | null> => {
      ...
      try {
        ...
        console.log("[useTransportByChantierUnified] Found transport data");
