                          ...
                          try {
                            ...
                            action: "correction_rh",
                              ...
                              details: {
                                ...
                                message: `Correction administrative : Heures normales modifié pour ${data?.salarie?.prenom || ""} ${data?.salarie?.nom || ""}`.trim(),
                              },
                            });
                            ...
                            try {
                              await logModification.mutateAsync({
                                ...
                                details: {
                                  ...
                                  date: day.date,
                                  chantier: day.chantier,
                                  message: `Correction administrative : Heures intempéries modifié pour ${data?.salarie?.prenom || ""} ${data?.salarie?.nom || ""}`.trim(),
                                },
                              });
                            } catch (e) { console.error("Log error:", e); }
                          }
                            ...
                            try {
                              await logModification.mutateAsync({
                                ...
                                details: {
                                  ...
                                  date: day.date,
                                  chantier: day.chantier,
                                  message: `Correction administrative : Code trajet modifié pour ${data?.salarie?.prenom || ""} ${data?.salarie?.nom || ""}`.trim(),
                                },
                              });
                            } catch (e) { console.error("Log error:", e); }
                          }
                            ...
                            try {
                              await logModification.mutateAsync({
                                ...
                                details: {
                                  ...
                                  message: `Correction administrative : Code trajet (lot) modifié pour ${data?.salarie?.prenom || ""} ${data?.salarie?.nom || ""}`.trim(),
                                },
                              });
                            } catch (e) { console.error("Log error:", e); }
                          }
