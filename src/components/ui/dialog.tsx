...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-5 h-8 w-8 flex items-center justify-center rounded-md opacity-70 ring-offset-background transition-all hover:opacity-100 hover:ring-2 hover:ring-orange-500 focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
